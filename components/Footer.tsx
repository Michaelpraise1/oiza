    ...
    <footer id="contact" className="footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Contact Us</h4>
            <p style={{ color: "#cbd5e1", marginBottom: "12px" }}>123 Medical Plaza<br/>Suite 400<br/>New York, NY 10001</p>
            <p style={{ color: "#cbd5e1", marginBottom: "12px" }}>Phone: (800) 555-1234</p>
